<x-layouts.client-layout title="{{ $search }}">
    ...
    <div class="justify-center mx-auto">
        ...
        <nav aria-label="Breadcrumb">
            <ol role="list" class="ml-14 mt-6 flex max-w-2xl items-center space-x-2 px-6 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <li class="text-sm">
                    <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Busqueda: {{ $search }} </a>
                </li>
            ...
            <div class="bg-white col-end-7 col-span-5">
                <div class="container">
                    ...
                    <div class="mx-auto max-w-2xl px-4 py-5 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
                        ...
                        <h1 class="text-center mb-10 text-5xl font-extrabold dark:text-white"><small class="ml-2 font-semibold text-gray-500 dark:text-gray-400">Busqueda: {{ $search }}</small></h1>
