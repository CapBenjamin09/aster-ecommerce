<x-layouts.client-layout title="{{ $category->name }}">
    <div class="bg-white pl-10">
        ...
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <h1 class="text-center mb-10 text-5xl font-extrabold dark:text-white"><small class="ml-2 font-semibold text-gray-500 dark:text-gray-400">Productos {{ $category->name }}</small></h1>
