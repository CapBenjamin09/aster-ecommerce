<x-layouts.client-layout title="Editar usuarios">
    ...
    <div class="container static px-10 py-10">
        ...
        <form class="border border-amber-200 shadow-md rounded-2xl px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('profile.update', $user )}}">
            @csrf
            @method('PATCH')
            ...
            <div class="flex mb-10">
                ...
                <input type="text" id="name" name="name" value="{{ $user->name }}" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe tu nombre">
            </div>
            ...
            <div class="flex mb-10">
                ...
                <input type="email" id="email" name="email" value="{{ $user->email }}" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe tu correo electrónico">
            </div>
            ...
            <div class="flex mb-10">
                ...
                <input type="number" id="phone" name="phone" value="{{ $user->phone }}" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe tu número de teléfono">
            </div>
            ...
            <div class="mt-10">
                ...
                <x-a-button type_button="primary" href="{{ route('profile.index', auth()->user()->id)}}"> Regresar </x-a-button>
            </div>
